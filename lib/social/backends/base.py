...
from lib.social.utils import SSLHttpAdapter, module_member, parse_qs, user_agent
from lib.social.exceptions import AuthFailed
...
class BaseAuth(object):
    ...
    def get_user(self, user_id):
        ...
        """
        from lib.social.strategies.utils import get_current_strategy
