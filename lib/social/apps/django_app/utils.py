...
from lib.social.utils import setting_name, module_member
from lib.social.exceptions import MissingBackend
from lib.social.strategies.utils import get_strategy
from lib.social.backends.utils import get_backend


BACKENDS = settings.AUTHENTICATION_BACKENDS
STRATEGY = getattr(settings, setting_name('STRATEGY'),
                   'lib.social.strategies.django_strategy.DjangoStrategy')
STORAGE = getattr(settings, setting_name('STORAGE'),
                  'lib.social.apps.django_app.default.models.DjangoStorage')
